...
app.listen(3693,()=>{
    console.log("Listening to port 3693")
})
...
let connectedToMongoDB = async () => {
    try {
    await mongoose.connect("mongodb+srv://mastanbee1994_db_user:mastanmymongo@masclus1.wq5yqvp.mongodb.net/Batch2509?appName=Masclus1");
